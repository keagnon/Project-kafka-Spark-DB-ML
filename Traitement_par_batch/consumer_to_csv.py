...
topicName = 'raw_velib_data'  # Nom du topic Kafka
...
with open('aggregated_velib_data.csv', mode='w') as csv_file:
    ...
    fieldnames = ['station_id', 'name', 'latitude', 'longitude','capacity','stationCode','numBikesAvailable','num_bikes_available_types_mechanical','num_bikes_available_types_ebike','numDocksAvailable']
